...
define('G5_MYSQL_USER', 'calc1020');
define('G5_MYSQL_PASSWORD', 'Apfmtl1!db');
define('G5_MYSQL_DB', 'calc1020');

//define('G5_MYSQL_HOST', '49.247.30.141');
//define('G5_MYSQL_USER', 'root');
//define('G5_MYSQL_PASSWORD', 'v7Kx0sH~3s[77%CdtL6k');
//define('G5_MYSQL_DB', 'cal');

define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '2d276ab715a160bc3c0b719648e7a9ef'); // 토큰 암호화에 사용할 키
